  ...
  projects: [
    {
      ...
      desc:  "A real-time AI chat platform with streaming responses, multi-model support, persistent history, and subscription billing via Stripe.",
    ...
    },
    {
      ...
      desc:  "Comprehensive analytics platform with live data visualization, custom charts, automated reports, and multi-tenant architecture.",
    ...
    },
    {
      ...
      desc:  "Full-featured e-commerce platform with inventory management, Stripe payments, and an admin dashboard built on the T3 stack.",
